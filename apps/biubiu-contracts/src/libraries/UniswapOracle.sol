...
library UniswapOracle {
    ...
    /// @notice Price floor: $100. If spot price is manipulated below this, use $100 instead.
    uint256 internal constant MIN_ETH_PRICE = 100e8;

    /// @notice Get ETH price in USD (8 decimals), floored at $100
