...
import type { NftMultisenderNetworkConfig } from '../types';
...
export const NETWORKS: Record<string, NftMultisenderNetworkConfig> = {
    ethereum: {
        name: 'Ethereum',
        chainId: 1,
        rpcs: [
        ...
        symbol: 'ETH',
        erc721DistributionAddress: PLACEHOLDER,
        erc1155DistributionAddress: PLACEHOLDER,
