		...
		<section id="featured" class="featured" use:fadeInUp={{ delay: 0 }}>
			...
			<a href={localizeHref('/apps/revoke')} class="tool-card glass-card">
				<div class="tool-content">
					...
					<p class="tool-description">{t('featured.revoke.description')}</p>
					<div class="tool-tags">
						<span class="tool-tag">{t('featured.revoke.feature1')}</span>
						<span class="tool-tag">{t('featured.revoke.feature2')}</span>
						<span class="tool-tag">{t('featured.revoke.feature3')}</span>
					</div>
				</div>
				<div class="tool-cta">
			...
			<a href={localizeHref('/apps/seal')} class="tool-card glass-card">
				<div class="tool-content">
					...
					<div class="tool-tags">
						<span class="tool-tag">{t('featured.capsule.feature1')}</span>
						<span class="tool-tag">{t('featured.capsule.feature2')}</span>
						<span class="tool-tag">{t('featured.capsule.feature3')}</span>
					</div>
				</div>
				<div class="tool-cta">
					<span class="tool-cta-text">{t('featured.capsule.cta')}</span>
					<svg class="tool-cta-arrow" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
						<line x1="5" y1="12" x2="19" y2="12"/>
						<polyline points="12 5 19 12 12 19"/>
					</svg>
			...
			<a href={localizeHref('/chains')} class="tool-card glass-card">
				<div class="tool-content">
					...
					<p class="tool-description">{t('featured.chainExplorer.description')}</p>
					<div class="tool-tags">
						<span class="tool-tag">{t('featured.chainExplorer.feature1')}</span>
						<span class="tool-tag">{t('featured.chainExplorer.feature2')}</span>
						<span class="tool-tag">{t('featured.chainExplorer.feature3')}</span>
					</div>
				</div>
				<div class="tool-cta">
